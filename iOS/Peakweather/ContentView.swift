...
struct ContentView: View {
    ...
    @State private var editingEntry: SummitEntry?
            ...
            ZStack {
                ...
                if store.entries.isEmpty {
                    VStack(spacing: 12) {
                        ...
                        Text("Tap + to log your first summit.")
                            .font(Theme.font(15))
...
struct EntryFormView: View {
    ...
    let existingID: UUID?
    let onSave: (SummitEntry) -> Void
    @FocusState private var focusedField: Field?

    enum Field { case title, detail1, detail2, note }

    init(entry: SummitEntry?, onSave: @escaping (SummitEntry) -> Void) {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existingID == nil ? "Add Summit" : "Edit Summit")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var entry = SummitEntry(title: title, detail1: detail1, detail2: detail2, note: note, date: date)
