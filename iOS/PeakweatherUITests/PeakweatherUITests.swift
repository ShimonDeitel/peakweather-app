...
final class PeakweatherUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        titleField.tap()
        titleField.typeText("New Summit")
        app.buttons["saveButton"].tap()
        XCTAssertTrue(app.staticTexts["New Summit"].waitForExistence(timeout: 2))
    }
    ...
    func testKeyboardDismissesOnTapOutside() {
        ...
        app.staticTexts["Add Summit"].tap()
